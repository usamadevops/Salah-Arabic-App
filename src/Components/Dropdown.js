...
function Dropdown({ label,setData,data,defaultval }) {
    ...
    return (
        <View style={{ paddingHorizontal: 20,zIndex:100, }}>
            ...
            <Animated.ScrollView style={{ flex: 1, backgroundColor: '#f5f5f5', position: 'absolute',alignSelf:'center',height:open?300:0, width: '100%', borderRadius: 10, borderWidth: open ? 0.5 : 0,zIndex:100,elevation:5,top:120,overflow:'hidden', }}>
